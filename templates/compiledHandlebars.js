...
this["DD"]["templates/header.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<script id=\"header\" type=\"text/x-handlebars-template\">\n	<h1 class=\"logo\"><a href=\"#\">Greens!</a></h1>\n    <ul class=\"main-nav\">\n        <li><a id=\"clickProducts\" href=\"#\">Products</a></li>\n        <li><a id=\"clickAbout\" href=\"#\">About</a></li>\n        <li><a id=\"clickContact\" href=\"#\">Contact</a></li>\n        <!--  with cloudfire internet connection\n        	<li><a id=\"shoppingCartClick\" href=\"#\"><i class=\"fas fa-shopping-cart\"></i></a></li>\n        -->\n        <li><a id=\"shoppingCartClick\" href=\"#\">shopping cart</a></li>\n    </ul>\n</script>";
},"useData":true});

this["DD"]["templates/homePage.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<script id=\"homePage\" type=\"text/x-handlebars-template\">\n    <header class=\"header\"> \n    </header>\n    <div class=\"banner green-dots animated fadeIn\">\n        <h2>Hungry for some greens?</h2>\n        <span>nutritious products for a healthier you</span>\n    </div>\n    <div class=\"message-blank\"></div>\n    <div class=\"products animated fadeIn delay-1s\">\n        <div class=\"category-list\"></div>\n        <div class=\"product-list\"></div>\n    </div>\n    <div class=\"about\">\n      <h2 class=\"giant\">Big 'ol' About Section</h2>\n    </div>\n    <div class=\"contact\">        \n      <h2 class=\"giant\">Contact Section</h2>\n<!--             <form id=\"email-contact\">\n          <select>\n            <option>Free Consultation</option> \n            <option>Product</option>\n            <option>Learn more</option>\n          </select>\n          <input type=\"text\" placeholder=\"Email Address\"/>\n          <input type=\"button\" value=\"Send\"/>\n        </form> -->\n    </div>\n    <footer></footer>\n    <div class=\"copyright\"><span>Copyright 2018 Level Ads, LLC. All rights reserved.</span> | <a href=\"#\" id=\"termsOfUse\">Terms of Use</a>\n    </div>\n</script>";
},"useData":true});
...
this["DD"]["templates/termsAndConditions.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<script id=\"termsAndConditions\" type=\"text/x-handlebars-template\">\n	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nibh sed pulvinar proin gravida hendrerit lectus a. Ac turpis egestas maecenas pharetra convallis posuere morbi. Volutpat commodo sed egestas egestas fringilla. Accumsan lacus vel facilisis volutpat est velit egestas dui. Luctus accumsan tortor posuere ac ut. Amet nisl purus in mollis nunc sed id semper. Nunc sed velit dignissim sodales ut eu. Massa eget egestas purus viverra accumsan in nisl nisi scelerisque. Ut ornare lectus sit amet est placerat in egestas erat.</p>\n\n	<p>Elit eget gravida cum sociis natoque. Cursus euismod quis viverra nibh cras pulvinar mattis nunc sed. A condimentum vitae sapien pellentesque habitant morbi. Et pharetra pharetra massa massa ultricies. Turpis egestas maecenas pharetra convallis. Hendrerit dolor magna eget est lorem ipsum dolor sit amet. Sapien eget mi proin sed libero. Libero volutpat sed cras ornare. Volutpat sed cras ornare arcu dui vivamus arcu. Pulvinar pellentesque habitant morbi tristique senectus. Id consectetur purus ut faucibus pulvinar elementum integer. Eget gravida cum sociis natoque penatibus. Augue neque gravida in fermentum et sollicitudin. Morbi tristique senectus et netus et malesuada fames ac turpis. Vitae nunc sed velit dignissim sodales ut. Turpis nunc eget lorem dolor sed viverra ipsum nunc aliquet. Lobortis scelerisque fermentum dui faucibus in ornare quam viverra. Egestas purus viverra accumsan in.</p>\n\n	<p>Id eu nisl nunc mi ipsum faucibus. Ut sem viverra aliquet eget sit amet. Placerat orci nulla pellentesque dignissim enim. Adipiscing enim eu turpis egestas pretium aenean pharetra. Urna nec tincidunt praesent semper feugiat nibh sed. Gravida rutrum quisque non tellus orci ac. Metus aliquam eleifend mi in nulla posuere sollicitudin aliquam ultrices. Interdum consectetur libero id faucibus nisl tincidunt eget nullam non. Consectetur libero id faucibus nisl tincidunt eget nullam non. Condimentum lacinia quis vel eros.</p>\n\n	<p>Cursus risus at ultrices mi tempus imperdiet nulla. Mauris rhoncus aenean vel elit scelerisque mauris pellentesque pulvinar. Erat nam at lectus urna duis convallis convallis. Ac tortor dignissim convallis aenean et tortor at. Cursus euismod quis viverra nibh cras. Tempor nec feugiat nisl pretium fusce id velit. Rhoncus mattis rhoncus urna neque viverra justo nec ultrices. Pellentesque elit eget gravida cum sociis. Nibh sit amet commodo nulla facilisi nullam vehicula ipsum. Mauris in aliquam sem fringilla ut morbi tincidunt augue interdum. Id eu nisl nunc mi ipsum faucibus.</p>\n</script>";
},"useData":true});

this["DD"]["templates/vic20.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<script id=\"vic20\" type=\"text/x-handlebars-template\">\n	<h2>Vic 20 Land!</h2>\n</script> ";
},"useData":true});
...
this["DD"]["templates/checkout/importUserForm.handlebars"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<script id=\"importUserForm\" type=\"text/x-handlebars-template\">\n   <div id=\"registration\">\n      <form id=\""
...
this["DD"]["templates/checkout/importUserPage.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function";

  return "<script id=\"importUserPage\" type=\"text/x-handlebars-template\">\n	<div class=\"checkoutForm-container\">\n		<div class=\"checkoutForm\">\n			"
    + ((stack1 = ((helper = (helper = helpers.checkoutForm || (depth0 != null ? depth0.checkoutForm : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"checkoutForm","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\n		</div>\n		<div class=\"productsInCart\">\n			<h2 class=\"underline\">Checkout Items</h2>\n			<div class=\"rounded\">\n				"
    + ((stack1 = ((helper = (helper = helpers.productsInCart || (depth0 != null ? depth0.productsInCart : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"productsInCart","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\n			</div>\n			<div class=\"checkoutTotals\">\n				<span>Total:</span>\n				<span class=\"grandTotal\"></span>\n			</div>\n		</div>\n	</div>\n</script>";
...
this["DD"]["templates/checkout/shoppingCartEmpty.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<script id=\"shoppingCartEmpty\" type=\"text/x-handlebars-template\">\n	<h2 class='modal-single-message'>No items in cart</h2>\n</script>";
},"useData":true});

this["DD"]["templates/checkout/shoppingCartPage.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper;

  return "<script id=\"shoppingCartPage\" type=\"text/x-handlebars-template\">\n	<div class=\"shoppingCart\">\n	   <div class=\"productsAndTotals\">\n	   		<h2 class=\"underline\">Your Items</h2>\n			<div class=\"rounded\">\n				"
...
this["DD"]["templates/checkout/thankYouPage.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper;
...
this["DD"]["templates/product/productCategories.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

  return "<script id=\"productCategories\" type=\"text/x-handlebars-template\">\n	<div class=\"category\" data-categoryname=\""
...
this["DD"]["templates/product/products.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

  return "<script id=\"products\" type=\"text/x-handlebars-template\">\n	<div class=\"product-container\" data-campaignId="
    + alias4(((helper = (helper = helpers.campaignId || (depth0 != null ? depth0.campaignId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"campaignId","hash":{},"data":data}) : helper)))
    + " data-productId="
    + alias4(((helper = (helper = helpers.productId || (depth0 != null ? depth0.productId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"productId","hash":{},"data":data}) : helper)))
...
this["DD"]["templates/product/productsEmpty.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<script id=\"productsEmpty\" type=\"text/x-handlebars-template\">\n	<div class=\"productsEmpty\">\n		<h3>No Products Chosen</h3>\n	</div>\n</script>\n";
},"useData":true});

this["DD"]["templates/product/productWithModifiers.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

  return "<script id=\"productWithModifiers\" type=\"text/x-handlebars-template\">\n	<div class=\"product-container\" data-campaignId="
    + alias4(((helper = (helper = helpers.campaignId || (depth0 != null ? depth0.campaignId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"campaignId","hash":{},"data":data}) : helper)))
    + " data-productId="
    + alias4(((helper = (helper = helpers.productId || (depth0 != null ? depth0.productId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"productId","hash":{},"data":data}) : helper)))
...
this["DD"]["templates/product/terms.handlebars"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<script id=\"terms\" type=\"text/x-handlebars-template\">\n    <section class=\"terms\">\n        <h3>Terms & Conditions</h3>\n        <p>blah blah</p>\n    </section>\n</script>";
},"useData":true});